    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          <p>KbadiWala is a leading online Waste Collecting Company in the India. We are committed to providing the best quality services at the best timing solution</p>
      ...
      <div className='footerin2' >
        <h3>© Copyright 2023 Kabadiwala, Inc.  All rights reserved</h3>
