        ...
        <nav>
            <div className='s1'>
                ...
                <div className='searchbar'>
                    <input typ="text" placeholder="Search your product categries" className='search' />
            ...
            <div className='s2'>
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                                    <Dropdown.Item href="#/action-1">Paper Waste</Dropdown.Item>
                                    <Dropdown.Item href="#/action-2">Electric Waste</Dropdown.Item>
                                    <Dropdown.Item href="#/action-3">Ploythin</Dropdown.Item>
                                    <Dropdown.Item href="#/action-3">Iron Waste</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
                <Link to='/about'>
                    <a>About Us</a>
